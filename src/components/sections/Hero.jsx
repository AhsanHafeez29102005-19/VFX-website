...
//             <img src={hero1} alt="VFX cleanup studio" />
//           </div>
//         </div>
//       </div>
//     </section>
      ...
      <div className="container hero__inner">
        <div className="hero__content">
          <span className="eyebrow">
             Professional VFX Cleanup Services
          </span>
<h1 className="hero__heading">
             Invisible VFX Cleanup that
         <span className="hero__highlight">
          ...
          <p className="hero__text">
            I help filmmakers, agencies, brands and content creators remove
            unwanted objects, wires, logos, microphones and distractions from
            videos naturally.
          </p>
