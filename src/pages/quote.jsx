...
const nextSteps = [
  ...
  {
    icon: "Clock",
    text: "I send you the price, deadline and a small sample (if needed).",
  },
      ...
      <section className="page-hero" style={{ paddingBottom: 24 }}>
        <div className="container" style={{ textAlign: "center" }}>
          ...
          <p className="quote__lead">
            Tell me about your project and I'll review it for free.
          </p>
        </div>
      </section>
        ...
        <div className="quote__form-card">
          ...
          {submitted ? (
            <div className="quote__success">
              ...
              <p>
                I've opened WhatsApp with your request pre-filled — just hit
                send there. If it didn't open (pop-up blocked), use one of the
                options below instead.
              </p>
              <div className="quote__success-actions">
                <Button
                  href={`https://wa.me/923061234567?text=${encodeURIComponent(message)}`}
                  variant="primary"
                  icon={<Icon.Whatsapp width={15} height={15} />}
                >
                  Open WhatsApp
                </Button>
                <Button
                  onClick={() => sendViaEmail("New Quote Request", message)}
                  variant="outline"
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="quote__upload">
                ...
                <span>
                  Google Drive, Dropbox, WeTransfer, Frame.io links also work
                </span>
              </div>
              ...
              <Button
                type="submit"
                variant="primary"
                icon={<Icon.Send width={15} height={15} />}
              >
                Submit Request
              </Button>
            </form>
